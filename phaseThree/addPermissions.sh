...
DB_HOST=$(grep "define( *[\"']DB_HOST[\"'] *" $CONFIG_FILE | sed -E "s/.*[\"']DB_HOST[\"'] *,  **[\"']([^\"']+)[\"'].* */\1/")
DB_ROOT_USER=$1
DB_ROOT_PASS=$2

DB_NAME=$(grep "define( *[\"']DB_NAME[\"'] *" $CONFIG_FILE | sed -E "s/.*[\"']DB_NAME[\"'] *,  **[\"']([^\"']+)[\"'].* */\1/")
DB_USER=$(grep "define( *[\"']DB_USER[\"'] *" $CONFIG_FILE | sed -E "s/.*[\"']DB_USER[\"'] *,  **[\"']([^\"']+)[\"'].* */\1/")
DB_PASS=$(grep "define( *[\"']DB_PASSWORD[\"'] *" $CONFIG_FILE | sed -E "s/.*[\"']DB_PASSWORD[\"'] *,  **[\"']([^\"']+)[\"'].* */\1/")
